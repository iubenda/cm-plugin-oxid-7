        ...
        <tr>
            <td colspan="2">
                ...
                <FIELDSET id=fldLayout>
                    <LEGEND id=lgdLayout>
                        <label for="test_editlanguage">[{oxmultilang ident="CMCONSENTMANAGER_SHOPLANGUAGE" suffix="COLON"}]</label>
                        <select name="editlanguage" id="test_editlanguage" class="saveinnewlanginput" onChange="document.myedit.submit();" [{$readonly}]>
